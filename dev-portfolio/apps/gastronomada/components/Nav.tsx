  ...
  return (
    <div ref={navRef} className="sticky top-0 z-20">
      ...
      <div className="flex h-20 items-center justify-between bg-gold px-6 md:hidden">
        <Link href="/" onClick={cerrarTodo} className="flex shrink-0 items-center">
        ...
        <div className="flex flex-col gap-1 border-t border-very-dark/10 bg-gold px-4 py-3 md:hidden">
          ...
          {active === "recetas" && (
            <div className="flex flex-col gap-1 px-3 pb-2">
              ...
              <Link href="/pages/recetas-modernas" onClick={cerrarTodo} className={mobileSub}>
                Gastronomía moderna
              </Link>
            </div>
          )}
          ...
          {/* Foro */}
          <Link href="/pages/foro" onClick={cerrarTodo} className={mobileItem}>
            Foro gastronómico
          </Link>

          {/* Buzón */}
          <Link href="/pages/buzon" onClick={cerrarTodo} className={mobileItem}>
          ...
          {active === "perfil" && (
            <div className="flex flex-col gap-1 px-3 pb-2">
              <Link href="/pages/perfil" onClick={cerrarTodo} className={mobileSub}>
                <UserCircle className="size-4" />
                Mi perfil
              </Link>
              <Link
